...
export default function AlloggioCard({ accommodation, onEdit, onDelete }: AlloggioCardProps) {
  ...
  return (
    <div className="rounded-3xl border border-slate-200/80 bg-white p-4.5 shadow-sm hover:border-slate-300 transition-all">
      <div className="flex items-start gap-3">
        <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-3 mt-2.5 flex-wrap">
              {accommodation.bookingCode && (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 font-mono text-[11px] bg-slate-100 px-2 py-1 rounded-lg border border-slate-200 text-slate-700 hover:border-purple-300 hover:text-purple-700 transition-all cursor-pointer active:scale-95"
                >
          ...
          {/* Note */}
          {accommodation.notes && (
            <p className="text-xs text-slate-600 mt-2.5 p-2.5 rounded-xl bg-slate-50 border border-slate-100 leading-relaxed">
              {accommodation.notes}
            </p>
          )}
          ...
          {accommodation.bookingUrl && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1 text-xs text-purple-600 hover:text-purple-700 mt-3 font-semibold transition-colors"
            >
