        ...
        <div className="bg-[#111827] border border-slate-800/80 rounded-3xl p-5 shadow-2xl space-y-4">
          ...
          <div className="flex bg-[#1f2937] p-1 rounded-xl">
            <button
              ...
              className={`flex-1 py-2 text-center text-[12px] font-black rounded-lg transition-all ${
                isRegistering ? "bg-blue-600 text-white shadow-md" : "text-slate-400 hover:text-white"
              }`}
            >
              Crea account
            </button>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full h-11 bg-white text-slate-900 font-extrabold text-[13.5px] rounded-xl flex items-center justify-center transition-all active:scale-98 shadow-md disabled:opacity-50"
          >
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] uppercase tracking-wider font-black text-slate-600">oppure</span>
            <span className="h-[1px] bg-slate-800 flex-1" />
          </div>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full h-11 bg-[#1f2937] hover:bg-[#374151] text-white font-bold text-[13.5px] rounded-xl flex items-center justify-center gap-2.5 transition-all active:scale-98 shadow-sm border border-slate-800 disabled:opacity-50"
          >
